...
#
# Created: Tue Nov 18 20:45:33 2014
...
class Ui_AddCongregationWindow(object):
    def setupUi(self, AddCongregationWindow):
        ...
        self.lineEdit_5 = QtGui.QLineEdit(self.frame_5)
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.gridLayout_9.addWidget(self.lineEdit_5, 0, 2, 1, 1)
        self.label_9 = QtGui.QLabel(self.frame_5)
        self.label_9.setObjectName("label_9")
        self.gridLayout_9.addWidget(self.label_9, 1, 0, 1, 1)
        self.lineEdit_6 = QtGui.QLineEdit(self.frame_5)
        self.lineEdit_6.setObjectName("lineEdit_6")
        self.gridLayout_9.addWidget(self.lineEdit_6, 1, 2, 1, 1)
        ...
        AddCongregationWindow.setTabOrder(self.line_f_name, self.line_phone)
        AddCongregationWindow.setTabOrder(self.line_phone, self.line_email)
        AddCongregationWindow.setTabOrder(self.line_email, self.lineEdit)
        AddCongregationWindow.setTabOrder(self.lineEdit, self.lineEdit_2)
        AddCongregationWindow.setTabOrder(self.lineEdit_2, self.lineEdit_3)
        AddCongregationWindow.setTabOrder(self.lineEdit_3, self.lineEdit_4)
        AddCongregationWindow.setTabOrder(self.lineEdit_4, self.lineEdit_5)
        AddCongregationWindow.setTabOrder(self.lineEdit_5, self.lineEdit_6)
        AddCongregationWindow.setTabOrder(self.lineEdit_6, self.text_note)
